        ...
        for (SectionType type : SectionType.values()) {
            ...
            if (HtmlUtil.isEmpty(value) && values.length < 2) {
                ...
                switch (type) {
                    ...
                    case ACHIEVEMENT:
                    case QUALIFICATION:
                        r.addSection(type, new MarkedTextSection(value.split("\\n")));
                        break;
                    case EDUCATION:
                    case EXPERIENCE:
                            ...
                            if (!HtmlUtil.isEmpty(name)) {
                                ...
                                for (int j = 0; j < titles.length; j++) {
                                    if (!HtmlUtil.isEmpty(titles[j])) {
                                        positions.add(new Experience.Position(HtmlUtil.parse(startDates[j]), HtmlUtil.parse(endDates[j]), titles[j], descriptions[j]));
                                    }
                                }
            ...
            case "edit":
                ...
                for (SectionType type : SectionType.values()) {
                    ...
                    switch (type) {
                        ...
                        case QUALIFICATION:
                            if (section == null) {
                                section = MarkedTextSection.EMPTY;
                            }
                            break;
                        case EXPERIENCE:
                        case EDUCATION:
